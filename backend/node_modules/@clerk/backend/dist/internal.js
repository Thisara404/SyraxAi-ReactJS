...
var API_VERSION = "v1";
var USER_AGENT = `${"@clerk/backend"}@${"1.9.0"}`;
...
var createAuthenticateContext = async (clerkRequest, options) => {
  const cookieSuffix = options.publishableKey ? await (0, import_keys.getCookieSuffix)(options.publishableKey, runtime_default.crypto.subtle) : "";
