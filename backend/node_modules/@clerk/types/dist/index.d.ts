...
type CoinbaseWeb3Provider = 'coinbase';
type Web3Provider = MetamaskWeb3Provider | CoinbaseWeb3Provider;
...
type __experimental_SessionVerificationLevel = 'L1.firstFactor' | 'L2.secondFactor' | 'L3.multiFactor';
type __experimental_SessionVerificationMaxAge = 'A1.10min' | 'A2.1hr' | 'A3.4hr' | 'A4.1day' | 'A5.1wk';
...
interface UserResource extends ClerkResource {
    ...
    __experimental_verifySession: (params: __experimental_SessionVerifyCreateParams) => Promise<__experimental_SessionVerificationResource>;
...
interface AuthenticateWithCoinbaseParams {
    customNavigate?: (to: string) => Promise<unknown>;
    redirectUrl?: string;
    signUpContinueUrl?: string;
    unsafeMetadata?: SignUpUnsafeMetadata;
